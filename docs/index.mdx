...
<Note>
The v1 program, oracle relayer, item swaps, and external-venue ([Meteora](https://www.meteora.ag)) support are built and tested locally but not yet deployed to a public cluster. Program ID: `QsixfrupxfVEDDYuQsR4vJcE58bbNfctD9WjijM9BjM`. Production graded-card API sources remain planned work; pages that describe them say so explicitly.
</Note>
