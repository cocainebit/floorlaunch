...
<div className="fl-card-grid">
  <a className="fl-card-wrap" href="https://solscan.io/token/7iMMDFqAp2W5S4SiYKQWVC4QksDGvGRFQarzrpyZqA9N" target="_blank" rel="noreferrer">
    <div className="fl-card">
      <img src="/images/cards/ls-left.jpg" alt="The Last Supper, Panel I, floorlaunch original" noZoom />
    </div>
    <div className="fl-card-caption">The Last Supper · Panel I<br />floorlaunch original · 1/1 on mainnet</div>
  </a>
  <a className="fl-card-wrap" href="https://solscan.io/token/CQEWqnUSwn9RNFjwmeYXon8zKH6pztQuyoth2qWm55Ep" target="_blank" rel="noreferrer">
    <div className="fl-card">
      <img src="/images/cards/ls-center.jpg" alt="The Last Supper, Panel II, floorlaunch original" noZoom />
    </div>
    <div className="fl-card-caption">The Last Supper · Panel II<br />floorlaunch original · 1/1 on mainnet</div>
  </a>
  <a className="fl-card-wrap" href="https://solscan.io/token/DYSHhuajQG3iD87jBhbkGU5gyndaZAnxT5WVmkLM4EVa" target="_blank" rel="noreferrer">
    <div className="fl-card">
      <img src="/images/cards/ls-right.jpg" alt="The Last Supper, Panel III, floorlaunch original" noZoom />
    </div>
    <div className="fl-card-caption">The Last Supper · Panel III<br />floorlaunch original · 1/1 on mainnet</div>
  </a>
</div>
