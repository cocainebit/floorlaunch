...
<Steps>
  ...
  <Step title="The token launches on a curve">
    Anyone can buy from the first block; the launch works like any memecoin curve, but it opens at a quarter of the collectible's live price and auto-migrates to the AMM exactly at that price once the raise target is met.
  </Step>
