...
**Graduation.** The permissionless transition from Bootstrap to Live once the curve raises `graduation_target_sol`. Splits raised SOL into the insurance fund and the AMM's real reserve, and starts the funding clock.
