...
Every floorlaunch token is launched against a real collectible: a graded card or an NFT collection floor. You do not need to own the collectible to launch, and any collectible can have any number of tokens launched against it.
